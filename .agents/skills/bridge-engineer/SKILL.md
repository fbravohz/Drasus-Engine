...
### 2b. Política de Comentarios — FFI/Bridge (addendum a `.agents/knowledge/base.md`)

El principio universal está en `.agents/knowledge/base.md`. Aquí los requisitos específicos del código de frontera:
