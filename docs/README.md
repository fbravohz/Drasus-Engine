...
| [**ADR-0112**](./ADR.md#adr-0112-veredicto-gate-g2--erradicacion-de-tch-rslibtorch-escalera-de-computo-numerico-soberano-ndarrayrayon-candle-burn) | Veredicto Gate G2 — Erradicación de `tch-rs`/libtorch; Escalera de Cómputo Numérico Soberano (`ndarray`/Rayon → `candle` → `burn`) |
| [**ADR-0113**](./ADR.md#adr-0113-veredicto-gate-g3--erradicacion-de-pysr-regresion-simbolica-como-modo-del-motor-genetico-nativo-y-diferimiento-de-la-mineria-simbolica-libre-a-moonshot-egg) | Veredicto Gate G3 — Erradicación de PySR; Regresión Simbólica como Modo del Motor Genético Nativo y Diferimiento de la Minería Simbólica Libre a Moonshot (`egg`) |
| [**ADR-0114**](./ADR.md#adr-0114-veredicto-gate-g4--motor-de-backtest-dual-con-ruta-express-hibrida-vectorizada-secuencial-modo-de-motor-elegido-por-el-usuario-y-contrato-de-consistencia-conservadora) | Veredicto Gate G4 — Motor de Backtest Dual con Ruta Express Híbrida (Vectorizada + Secuencial), Modo de Motor Elegido por el Usuario y Contrato de Consistencia Conservadora |
| [**ADR-0115**](./ADR.md#adr-0115-veredicto-gate-g5--verdict-engine-determinista-sin-llm-erradicacion-de-ollama-como-requisito) | Veredicto Gate G5 — Verdict Engine Determinista sin LLM; Erradicación de Ollama como Requisito |
| [**ADR-0116**](./ADR.md#adr-0116-veredicto-gate-g6--downsampling-obligatorio-en-backend-como-condicion-de-la-frontera-ffi-zerocopybuffer-solo-para-cargas-masivas) | Veredicto Gate G6 — Downsampling Obligatorio en Backend como Condición de la Frontera FFI; `ZeroCopyBuffer` solo para Cargas Masivas |
