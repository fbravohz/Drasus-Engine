...
| **ADRs** | ADR-0144 (cimiento #4) · ADR-0143 (tiers) · ADR-0137 (puertos `Order`/`UsageRecord`) · ADR-0141 (append-only + montos ×10⁸) · ADR-0020 (Perfil D) · ADR-0093 (secretos) · ADR-0142 (CLI verify) |
