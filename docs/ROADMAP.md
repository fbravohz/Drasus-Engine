...
**Alcance:** los **9 cimientos** (ADR-0144) **+ el cimiento #10 `verified-account-registry`** (ADR-0145), plomería crosscutting que vive en `crates/shared` (patrón `clock`/`audit-log`/`telemetry`) + la nueva superficie de la Cabina de Mando. Cada uno entrega su puerto tipado (ADR-0137) y su esquema greenfield (ADR-0141/ADR-0020 V2) **ahora**; los productos concretos (y el portal público, repo aparte) son adaptadores posteriores.
