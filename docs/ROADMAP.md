...
| **STORY-025 — Librería de Componentes Funcional, Neutral al Estilo y al Proyecto (ADR-0138 enmienda 2026-06-29)** — 51 componentes en `ui/lib/components/` (clases desnudas namespaced, funcionales, estilo por tema), galería→consumidora con mocks, tema `Drasus*`→neutral, índice `ui/COMPONENTS.md` | ✅ terminado (2026-06-30, build verde; `class Glow`=0, `class Glass`=solo tema; dedup `ColorPickerWidget` diferido) | [Orden](./execution/STORY-025-component-library.md) |
