...
- **Determinismo y reproducibilidad (ADR-0005 / ADR-0020):** el versionado y los 25 campos de fundación nacen en EPIC-0/EPIC-2; retrofitearlos cuesta 10x. Toda entrega debe poder reproducirse bit-a-bit con los comandos de validación de su Orden de Trabajo.
