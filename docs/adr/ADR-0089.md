> 🔶 **Generalizado por ADR-0111** — Los motores de optimización (Markowitz, HRP, etc.) se convierten en genes de acción parametrizables por el genoma evolutivo de cartera.
