...
*   **Reglas:**
    ...
    - **Inmutabilidad y Trazabilidad:** Cada resultado aceptado en el databank debe incluir el linaje completo, firma de hash del minero, y los campos de inundación de fundaciones que su Perfil Técnico exija (Grupo I universal + Perfil IA/R&D; Filtro de Relevancia, ADR-0020).
