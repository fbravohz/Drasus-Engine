...
* **Ver también:** ADR-0059 — Ventanas WFA fijas que este ADR hace adaptativas. ADR-0056 — Fuente del `regime_label` HMM que este ADR consume. ADR-0110 — Generaliza el estado HMM como gen de condición evolutivo.
