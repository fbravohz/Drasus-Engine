> ⚠️ **Superado por ADR-0087** — El Centinela expande esta decisión con Shadow Mode, Emergency PWA y el Guardián (Global Execution Router). La implementación canónica vive en ADR-0087.
