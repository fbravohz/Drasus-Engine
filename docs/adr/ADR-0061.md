...
*   **Mecanismo:**
    ...
    *   **Determinismo:** la ejecución CPU preserva siempre la semilla aleatoria para reproducibilidad bit-a-bit; si en el futuro se adopta `candle` para una GPU opcional, la ausencia de GPU jamás impide la ejecución.
...
* **Ver también:** ADR-0062 — Las 10 perturbaciones de robustez y la Física de Broker se ejecutan sobre este motor HPC.
