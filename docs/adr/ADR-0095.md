...
* **Ver también:** ADR-0025 — Gate pre-trade de 10 pasos en el cual este veto se integra como check adicional. ADR-0062 — Motor de robustez cuyas 10 perturbaciones (incluyendo variación de slippage/spread) alimentan el veredicto que este ADR consume. ADR-0087 — El Guardián (Global Execution Router) donde este veto se ejecuta.
