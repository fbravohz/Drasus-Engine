> 🔶 **Extendido por ADR-0150** — este ADR versiona el *artefacto* (qué es una estrategia/portafolio). ADR-0150 añade el registro del *evento* (la Expedition/corrida que lo produjo o tocó) y aplica este mismo mecanismo git-like a la definición de Pipeline. Son ortogonales y complementarios: la Expedition es la columna vertebral de procedencia que ata cada versión a la corrida que la generó, no un reemplazo del versionado.
