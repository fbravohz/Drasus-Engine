> 🔶 **Extendido por ADR-0132** — documenta el rechazo razonado de reescribir el núcleo en C++/Qt total frente a Rust, y fija cuándo reabrir la decisión de lenguaje del núcleo.
