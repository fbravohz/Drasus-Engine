> 🔶 **Extendido por ADR-0119** — El bus pub/sub zero-copy se reutiliza para telemetría entre nodos distribuidos, más allá del diseño original de datos de mercado.
