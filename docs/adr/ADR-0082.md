...
* **Ver también:** ADR-0081 — Capa base de gestión transaccional (Grid Trading, Hedging, Trailing Stop mecánico) sobre la cual este ADR añade la capa avanzada/institucional.
