...
*   **Reglas:**
    ...
    - **LLM Opcional y Soberano (CONFIG):** si se habilita, la inferencia es local vía `candle` embebido; **prohibido** Ollama como requisito y **prohibidas** las APIs externas (decisión propia de este ADR; ADR-0051 permite LLM locales o en la nube como traductor semántico, pero este ADR restringe adicionalmente a solo local para el veredicto).
