> 🔶 **Relacionado con ADR-0088** — ADR-0070 define alerta temprana (Pardo Profile, SSL). ADR-0088 define kill switch final (Cono de Silencio, Broken Strategy Flag). Son capas complementarias de protección en vivo.
