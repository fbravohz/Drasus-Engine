...
> 🔶 **Extendido por ADR-0140** — Plan explícito de diferimiento de opciones financieras con cinco prerrequisitos de activación y tres invariantes de diseño de costo cero.

* **Ver también:** ADR-0078 — Infraestructura de ejecución que este ADR redefine contractualmente. ADR-0034 — Adaptadores de ingesta API Delta sujetos a la gobernanza de este ADR.
