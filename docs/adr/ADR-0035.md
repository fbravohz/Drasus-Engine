> 🔶 **Extendido por ADR-0141** — añade política de evolución de esquema Parquet (schema_version, columnas solo se añaden), reconciler de integridad cruzada SQLite↔Parquet, y formato canónico de data_snapshot_id.
