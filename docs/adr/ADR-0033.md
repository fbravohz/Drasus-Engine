> 🔶 **Extendido por ADR-0119, ADR-0123 y ADR-0134** — ADR-0119 formaliza la topología distribuida de planos Control/Ejecución sobre SaaSCloudEngine. ADR-0123 añade MCP como cuarto canal de acceso al mismo nivel que FFI y gRPC. ADR-0134 concreta los modos a una matriz de sistemas operativos (Core nativo en Windows/Linux/macOS y VPS Linux; cliente delgado Flutter en móvil y Web vía gRPC). La taxonomía "trimodal" queda como base, pero la topología real es ahora de 4 canales y operación multi-nodo.
