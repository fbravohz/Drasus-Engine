> 🔶 **Extendido por ADR-0119 y ADR-0123** — ADR-0119 formaliza la topología distribuida de planos Control/Ejecución sobre SaaSCloudEngine. ADR-0123 añade MCP como cuarto canal de acceso al mismo nivel que FFI y gRPC. La taxonomía "trimodal" queda como base, pero la topología real es ahora de 4 canales y operación multi-nodo.
