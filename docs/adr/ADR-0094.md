> 🔶 **Complementado por ADR-0119** — La delegación híbrida de cómputo se formaliza en un patrón CQRS de Plano de Control / Plano de Ejecución para operación multi-nodo.
