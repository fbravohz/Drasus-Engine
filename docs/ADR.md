...
*   **Reglas:**
    ...
    - **Ventana de Verificación (CONFIG, declarada por Feature):** toda Feature sin superficie propia declara, en su sección "Dependencias y Bloqueantes" (TEMPLATES.md §3.8), cuál Feature consumidora expone su observable y CUÁL observable concreto (estado, conteo, timestamp, resultado) debe aparecer en la pestaña de esa Feature consumidora. Esa visibilidad ES la prueba de funcionamiento de la plomería.
...
*   **Trazabilidad:** ADR-0019, ADR-0028, ADR-0029, ADR-0096, ADR-0106, ADR-0115, ADR-0116, CONTENT-STRATEGY.md (Pilar G), ROADMAP §EPIC-0/§EPIC-8, TEMPLATES.md §3.8, [`clock.md`](./features/clock.md), [`audit-log.md`](./features/audit-log.md), [`async-job-executor.md`](./features/async-job-executor.md).
