...
### 2b. Política de Comentarios — FFI/Bridge (addendum a `.claude/knowledge/base.md`)

El principio universal está en `.claude/knowledge/base.md`. Aquí los requisitos específicos del código de frontera:
