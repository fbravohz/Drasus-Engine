...
* **Activación del QA-Engineer por fase (ADR-0133):** En EPIC-0 no es gate obligatorio por Story — disponible solo para casos puntuales que tú escales. Desde EPIC-1 en adelante, QA-Engineer (Etapa 5) es gate obligatorio antes de cerrar cualquier Story de lógica de dominio. Pre-dinero real (cualquier EPIC): las Pruebas de Guerra del QA skill §3 son bloqueantes de release.
